...
fn derive_theme(title: &str, body: &str) -> String {
    ...
    const THEMES: &[(&str, &[&str])] = &[
        ...
        (
            "Educação",
            &[
                "educa", "escola", "creche", "professor", "ensino", "universidad", "merenda",
                "alfabetiz",
            ],
        ),
        (
            "Segurança",
            &[
                "seguran", "polícia", "policia", "violênc", "violenc", "crime", "iluminação",
                "iluminacao",
            ],
        ),
        (
            "Transporte",
            &[
                "transport", "ônibus", "onibus", "mobilidad", "trânsit", "transit", "ciclovia",
                "metrô", "metro", "tarifa",
            ],
        ),
        (
            "Saneamento",
            &[
                "saneament", "esgoto", "água", "agua", "lixo", "resíduo", "residuo", "drenag",
                "enchent",
            ],
        ),
        (
            "Meio ambiente",
            &[
                "ambient", "poluiç", "poluic", "árvore", "arvore", "desmatament", "reciclag",
                "clima",
            ],
        ),
        (
            "Moradia",
            &[
                "moradia", "habitaç", "habitac", "aluguel", "despejo", "regulariz", "favela",
                "ocupaç", "ocupac",
            ],
        ),
        (
            "Trabalho e renda",
            &[
                "emprego", "trabalh", "renda", "desemprego", "informal", "microempre", "salário",
                "salario",
            ],
        ),
        (
            "Cultura e esporte",
            &[
                "cultura", "esporte", "quadra", "praça", "praca", "biblioteca", "teatro", "lazer",
            ],
        ),
        (
            "Assistência social",
            &[
                "assistênc", "assistenc", "bolsa", "fome", "vulnerab", "idoso", "criança",
                "crianca",
            ],
        ),
        (
            ...
            &[
                "direito", "cidadania", "lgbt", "racism", "mulher", "acessibilidad", "deficiênc",
                "deficienc",
            ],
        ),
        (
            "Infraestrutura",
            &[
                "asfalt", "pavimenta", "buraco", "obra", "ponte", "calçad", "calcad",
