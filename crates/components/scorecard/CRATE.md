...
NEW. Persistent, public, per-politician record: promises vs delivery, answered vs ignored, response latency. The accountability artifact Decidim never produced (failure #7).
...
| consumes | `consequence.official.responded` |
| consumes | `mandates.official.onboarded` |
