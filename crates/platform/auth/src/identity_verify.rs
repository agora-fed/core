...
//!
//! Enquanto [`CpfVerifier`](crate::credential::CpfVerifier) só olha o dígito verificador, aqui
//! confrontamos **nome + data de nascimento + sexo + CPF** com a base e recebemos um VEREDITO em
//! faixas (espelha o `scorer.py`: ACEITA/REVISA/ESCALA/REJEITA — não é probabilidade, é faixa
...
/// Porta plugável de verificação de identidade.
...
mod tests {
    ...
    fn deserializa_resposta_do_servico() {
        // Chave "faixa" (como o serviço devolve), mapeada pra faixa_raw via serde rename.
