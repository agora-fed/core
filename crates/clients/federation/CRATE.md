...
> Tier 3 crate. **One crate = one owner agent.** This file is the crate's
...
| Direction | Topic |
|-----------|-------|
| emits | `federation.instance.registered` |
| emits | `federation.signal.synced` |

## Owned tables

- `federation_instance`
- `federation_sync_cursor`
