-- 0651_municipio_ibge_seed.sql - povoa a referencia de municipios (IBGE, 5571).
-- Fonte: servicodados.ibge.gov.br/api/v1/localidades/municipios. Idempotente.
BEGIN;
INSERT INTO municipio_ibge (codigo_ibge, nome, uf) VALUES
