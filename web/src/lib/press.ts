...
const pt: PressContent = {
  ...
  headline:
    'DemocraciaBR: a plataforma soberana e aberta que quer tirar o governo das mãos das oligarquias e devolvê-lo ao povo',
  lede: 'A PopSolutions Software & Comunicação LTDA — uma empresa administrada cooperativamente — lança a DemocraciaBR com uma ambição maior que a de um site: mover o poder de governo para longe das oligarquias hereditárias e da distância burocrática que capturaram a política brasileira, e devolvê-lo às mãos do povo — não trocando quem governa, mas elevando a capacidade do próprio povo de se autogovernar.',
  body: [
    'A aposta tem raiz numa linhagem inteira da teoria política: a democracia participativa e deliberativa. A tese, de John Dewey a Elinor Ostrom, é direta — a suposta incapacidade do público de se governar não é natural, é produzida pela falta de participação. Burocracia e oligarquia não se corrigem trocando gestores; corrigem-se dando ao povo poder real e praticado. Do Orçamento Participativo de Porto Alegre à pedagogia de Paulo Freire, a evidência é a mesma: comunidades governam questões complexas por conta própria quando as regras são delas.',
    'É esse o desenho da DemocraciaBR. Diferente de uma rede social ou de um portal de petições, ela fecha um loop de consequência: o cidadão propõe, a comunidade apoia e vota, e ao cruzar um patamar a demanda é encaminhada ao gabinete responsável com um relógio de resposta público. Se o mandato responde, fica registrado; se silencia, o silêncio também vira registro — imutável e auditável — e alimenta o placar público daquele parlamentar.',
    ...
    'O horizonte é grande e o projeto assume isso: substituir, peça por peça, a desculpa técnica de que "o povo não dá conta" por engenharia institucional — sorteio verificável, deliberação que premia o consenso em vez da retórica, e poder de decisão real. Está em desenvolvimento ativo, rumo ao ciclo eleitoral de 2026.',
  ],
  quote:
    'Não queremos trocar quem manda. Queremos elevar a capacidade do povo de se autogovernar — é assim que se tira o poder das oligarquias: não com um novo dono, mas com um povo que já não precisa de dono.',
...
const en: PressContent = {
  ...
  headline:
    'DemocraciaBR: the sovereign, open platform that aims to take governing power from the oligarchies and return it to the people',
  lede: 'PopSolutions Software & Comunicação LTDA — a cooperatively-run company — launches DemocraciaBR with an ambition bigger than a website: to move governing power away from the hereditary oligarchies and the bureaucratic distance that captured Brazilian politics, and return it to the hands of the people — not by swapping who governs, but by raising the people’s own capacity to self-govern.',
  body: [
    'The wager rests on an entire lineage of political theory: participatory and deliberative democracy. The thesis, from John Dewey to Elinor Ostrom, is direct — the public’s supposed incapacity to govern is not natural, it is produced by the lack of participation. Bureaucracy and oligarchy are not fixed by swapping managers; they are fixed by giving people real, practiced power. From Porto Alegre’s participatory budgeting to Paulo Freire’s pedagogy, the evidence is the same: communities govern complex matters themselves when the rules are their own.',
    'That is DemocraciaBR’s design. Unlike a social network or a petition portal, it closes a consequence loop: a citizen proposes, the community backs and votes, and once a threshold is crossed the demand is forwarded to the responsible official’s office with a public response clock. If the official answers, it is recorded; if they stay silent, the silence is also recorded — immutable and auditable — and feeds that official’s public scorecard.',
    ...
    'The horizon is large and the project owns it: to replace, piece by piece, the technical excuse that "the people can’t handle it" with institutional engineering — verifiable sortition, deliberation that rewards consensus over rhetoric, and real decision power. It is under active development, heading toward the 2026 election cycle.',
  ],
  quote:
    'We are not out to change who rules. We are out to raise the people’s capacity to self-govern — that is how you take power from the oligarchies: not with a new owner, but with a people that no longer needs one.',
  quoteAttribution: 'PopSolutions Software & Comunicação LTDA',
...
const es: PressContent = {
  ...
  headline:
    'DemocraciaBR: la plataforma soberana y abierta que busca quitar el gobierno de manos de las oligarquías y devolvérselo al pueblo',
  lede: 'PopSolutions Software & Comunicação LTDA — una empresa administrada cooperativamente — lanza DemocraciaBR con una ambición mayor que la de un sitio web: mover el poder de gobierno lejos de las oligarquías hereditarias y de la distancia burocrática que capturaron la política brasileña, y devolvérselo a las manos del pueblo — no cambiando quién gobierna, sino elevando la capacidad del propio pueblo de autogobernarse.',
  body: [
    'La apuesta tiene raíz en toda una linaje de la teoría política: la democracia participativa y deliberativa. La tesis, de John Dewey a Elinor Ostrom, es directa — la supuesta incapacidad del público para gobernarse no es natural, la produce la falta de participación. La burocracia y la oligarquía no se corrigen cambiando gestores; se corrigen dándole al pueblo poder real y practicado. Del Presupuesto Participativo de Porto Alegre a la pedagogía de Paulo Freire, la evidencia es la misma: las comunidades gobiernan asuntos complejos por sí mismas cuando las reglas son suyas.',
    'Ese es el diseño de DemocraciaBR. A diferencia de una red social o un portal de peticiones, cierra un circuito de consecuencia: la persona propone, la comunidad respalda y vota, y al cruzar un umbral la demanda se envía al despacho responsable con un reloj de respuesta público. Si el cargo responde, queda registrado; si guarda silencio, el silencio también queda registrado — inmutable y auditable — y alimenta el marcador público de ese representante.',
    ...
    'El horizonte es grande y el proyecto lo asume: sustituir, pieza por pieza, la excusa técnica de que "el pueblo no da la talla" por ingeniería institucional — sorteo verificable, deliberación que premia el consenso en vez de la retórica, y poder de decisión real. Está en desarrollo activo, rumbo al ciclo electoral de 2026.',
  ],
  quote:
    'No buscamos cambiar quién manda. Buscamos elevar la capacidad del pueblo de autogobernarse — así se le quita el poder a las oligarquías: no con un nuevo dueño, sino con un pueblo que ya no necesita uno.',
  quoteAttribution: 'PopSolutions Software & Comunicação LTDA',
